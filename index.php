...
<body>
    ...
    <div class="banner-container">
        <h2 class="white pb-3">Better Places  Better Stays  Better Memories</h2>
    ...
    <div class="page-container">
        ...
        <div class="row">
            <div class="city-card-container col-md">
                <a href="property_list.php?city=Bhopal">
                    <div class="city-card rounded-circle">
                        <img src="img/Bhopal2.png" class="city-img" />
                    </div>
                </a>
            </div>
            ...
            <div class="city-card-container col-md">
                <a href="property_list.php?city=Gwalior">
                    <div class="city-card rounded-circle">
                        <img src="img/Gwalior.png" class="city-img" />
                    </div>
                </a>
            </div>
